...
namespace Parabox.CSG
{
    ...
    public struct Vertex
    {
        ...
        // Method to check if a vertex is effectively null
        public bool IsNull()
        {
            return !hasPosition && !hasColor && !hasNormal && !hasTangent && !hasUV0 && !hasUV2 && !hasUV3 && !hasUV4;
        }

        // Operator to compare Vertex with null
        public static bool operator ==(Vertex v1, object obj)
        {
            if (obj is null)
            {
                return v1.IsNull();
