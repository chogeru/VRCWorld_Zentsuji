...
namespace Parabox.CSG
{
    ...
    public sealed class Model
    {
        ...
        internal Model(List<Polygon> polygons)
        {
            ...
            {
                Debug.LogError("Model constructor: No polygons provided.");
                return;
            }
            ...
            for (int i = 0; i < polygons.Count; i++)
            {
                ...
                if (poly == null)
                {
                    Debug.LogError($"Model constructor: Polygon at index {i} is null.");
                    continue;
                }
                ...
                {
                    if (poly.vertices[0] == null || poly.vertices[j - 1] == null || poly.vertices[j] == null)
                    {
                        Debug.LogError($"Model constructor: Vertex is null in polygon at index {i}");
                        continue;
                    }
