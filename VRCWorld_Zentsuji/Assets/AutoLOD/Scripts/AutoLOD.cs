        ...
        void OnGUI()
        {
            ...
            if (showPreview)
            {
                ...
                if (previewRender != null && previewRender.camera != null)
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    float tmpWireframeOpacity = EditorGUILayout.Slider("Wireframe", wireframeOpacity, 0f, 1f);
            ...
            GUILayout.Label("v5.3.0 ", smallFont, GUILayout.Height(8));
            GUILayout.Label("AutoLOD © 2020-2024 ", smallFont, GUILayout.Height(8));
