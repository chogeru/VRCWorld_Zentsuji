Shader "AY_Shader/Skybox/StarrySkyMesh"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct appdata
            {
                ...
                //float3 texcoord : TEXCOORD0; //skyboxだけ
            };
...
//               https://github.com/stegu/webgl-noise
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //天球の回転
                float3 RotateTex = rotate(localDir,_Time.y*_RotateSpeed,_RotateAxis.xyz);
                ...
                //地平線
                color += pow(saturate(cos((localDir.y+_GroundOffset) * UNITY_PI)),_RefDamp)*_GroundRef * _GroundColor;
